...
namespace Prism
{
	...
	private:
		...
		PhysicsInterface(std::function<void(PhysicsComponent*, PhysicsComponent*, bool)> anOnTriggerCallback, std::function<void(PhysicsComponent*, PhysicsComponent*, CU::Vector3<float>)> aOnContactCallback);
		~PhysicsInterface();
