...
public:
	...
	static Entity* CreateEntity(unsigned int aGID, eEntityType aType, Prism::Scene* aScene, const CU::Vector3f& aPosition
		, const CU::Vector3f& aRotation = CU::Vector3f(), const CU::Vector3f& aScale = { 1.f, 1.f, 1.f });

	static Entity* CreateEntity(unsigned int aGID, eEntityType aType, std::string aSubType, Prism::Scene* aScene, const CU::Vector3f& aPosition
		, const CU::Vector3f& aRotation = CU::Vector3f(), const CU::Vector3f& aScale = { 1.f, 1.f, 1.f });
private:
